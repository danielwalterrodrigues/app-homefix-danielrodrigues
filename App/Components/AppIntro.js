...
export default class AppIntro extends Component {
  ...
  renderBasicSlidePage = (index, {
    ...
    const sizeAdjust = (windowsWidth / 380)
    imgStyle.height = imgStyle.height * sizeAdjust
    imgStyle.width = imgStyle.width * sizeAdjust
      ...
      <View style={[this.styles.slide, { backgroundColor }]} showsPagination={false} key={index}>
        ...
        <View style={this.styles.info}>
          <Animated.View style={AnimatedStyle2.transform}>
            <Text style={[this.styles.title, { color: fontColor }]} textBreakStrategy='simple'>{title}</Text>
          </Animated.View>
          <Animated.View style={AnimatedStyle3.transform}>
            <Text style={[this.styles.description, { color: fontColor, fontSize:(30 * sizeAdjust) }]} textBreakStrategy='simple'>{description}</Text>
          </Animated.View>
        </View>
